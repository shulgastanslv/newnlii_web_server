from sqlalchemy import Boolean, Column, Enum, Integer, String, DateTime, Text, Index, ForeignKey
...
class Notification(Base):
    ...
    actor = relationship("User", foreign_keys=[actor_id], back_populates="acted_notifications")
